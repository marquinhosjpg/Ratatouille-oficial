...
<body>
    ...
    <div class="navbar">
        <div class="navbar-left">
            ...
            <div class="receita">Receitas</div>
            <div class="enviereceita">envie sua receita</div>
            <div class="sobrenos">Sobre nós</div>
        </div>

        <div class="navbar-right">
        <div class="search-box">
        <form action="testeEcho.php" method="post">
        <input type="text" name="nomeR" class="search-text" placeholder="Pesquisar...">
            ...
            <a href="login.php"><div class="login">Entrar</div></a>
            <a href="cad.php"><div class="cadastro">Cadastrar</div></a>
        </div>
    </div>
    ...
    <div class="food-list-wrapper">
        <ul class="food-list">
            <li class="food-item">
                <a href="testeEcho.php" class="item-link">
                    ...
                    <div class="item-footer">
                        <input type="hidden" name="sim" value="7">
